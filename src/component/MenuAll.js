...
import {FaRegSmileWink, FaMedapps} from 'react-icons/fa'
        ...
        <div className="aontainer">
            ...
            <div className="firContainer">
                <div className="firItem1">
                    <h2><FaRegIdCard size="38" color="#ffff"/>  채용정보</h2>
                    <ul>
                        ...
                        <Link to="/hsJobInfo"><li><button>고졸채용</button></li></Link>
            ...
            <Link className="menuLink" to="/centerintro"> <button className="quest"><FaQuestionCircle size="35" color="#ffff"/>  이용안내</button></Link>
                <Link className="menuLink" to="/centerintro"><button className="centerde"><FaMedapps size="35" color="#ffff"/>{state.data.config.ADMIN_NAME} 소개</button></Link>
            </div>
        </div>
    )
}