...
export default function JobTest14( props ) {
    console.log(props)
    const style = {
        display: "flex",
    ...
    return (<section style={style}>
           ...
           <img style={{width:"30%"}} src="./jobTestback.png"></img>
            <h1 style={{position:"absolute",fontSize:"3vh", marginTop:"20vh", width:"20%"}}>교양 프로그램보다는 드라마나 오락프로그램을 더 좋아한다.</h1>
            <div style={btnboxStyle}>
                <button style={BtnSelectStyle} onClick={()=> props.btnClick(24)}> 
