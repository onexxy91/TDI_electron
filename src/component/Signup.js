...
export default function Signup({ history }) {
    ...
    return (
        ...
        backgroundImage: "linear-gradient(19deg, #21D4FD 0%, #6271b9 100%)"}}>
            ...
            <div style={divStyle}>
                <div style={infoStyle}>
                    <span style={textStyle}><strong>1)</strong> 수집하려는 개인정보 항목<br/>  성명, 이메일, 주소, 연락처</span>
                    <span style={textStyle}><strong>2)</strong> 어떤 목적으로 수집하고 이용하는지<br/>  디지털 인터뷰 메뉴 사용 및 면접 결과 안내</span>
                    <span style={textStyle}><strong>3)</strong> 이용기간<br/> 법령에 따른 보존기간 또는 탈퇴 후 7일 이내</span>
                    <span style={textStyle}><strong>4)</strong> 이노스피치 에서 수집하는 개인정보 제공동의에 <br/> 대해 동의하지않을 수 있으나, 이 경우 디지털인터뷰<br/> 메뉴 관련 서비스 이용이 제한됩니다.</span>
