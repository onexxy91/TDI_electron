...
export default function JobTest11( props ) {
    console.log(props)
    const style = {
        display: "flex",
    ...
    return (<section style={style}>
            ...
            <h1 style={{position:"absolute", height:"16vh", fontSize:"3vh", marginTop:"20vh", width:"75%"}}>하루 중 신문을 읽는 시간이 30분 이상 된다.</h1>
            <div style={btnboxStyle}>
                <button style={BtnSelectStyle} onClick={()=> props.btnClick(13)}> 
                    {/* <div style={btnABStyle}>A</div> */}
                    <span style={spanStyle}>YES</span>
                </button>
                <button style={BtnSelectStyle} onClick={()=> props.btnClick(12)}>
